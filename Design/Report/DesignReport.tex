...
\tableofcontents
\chapter{Abstract}
The Outreach and Research Build for Interactively Teaching Satellites, referred to as ORBITS herein, is a emulation system for a 1U CubeSat launch ecosystem including both a ground communication station and a physical ORBITS unit.
...
Each of these subsystems are required in order to satisfy one or more of the above requirements.
...
Communications are integral for the operations of this emulatory system. Implemented within the system are 2 forms of inter-device communication. WiFi is included with both the ground station and OBC with the ground station being able to generate its own hotspot that the OBC can connect to.

However, within CubeSat development WiFi is not used. To give an alternative communication method more in line with a CubeSat a wireless RF transceiver module has been included with both the ground station and ORBITS unit.
